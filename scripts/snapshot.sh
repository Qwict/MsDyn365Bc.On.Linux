...
# GC configurations while the checkpoint — and criu's time — halves. Kept as a
# diagnostic, since this NST needs vm.max_map_count >= 2^20 and a host that
# quietly lacks it fails here rather than somewhere legible.
#
